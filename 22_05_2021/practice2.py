...
while i < 3  and do_next:
    i += 1
    units_added = units_added + add_to_backpack(backpack_items, backpack_units, units_added)
    print(backpack_items)
    print(backpack_units)
    if( units_added >= 50 ):
        do_next = False
...
while do_battle:
    ...
    print(backpack_items)
    print(backpack_units)
    units_to_use, type = use_from_backpack(backpack_items, backpack_units)
